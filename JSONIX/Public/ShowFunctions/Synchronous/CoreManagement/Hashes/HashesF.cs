using Internal.Iinterface.CoreManagement.Hashes;
using Internal.Synchronous.CoreManagement.Hashes;
...
namespace Public.ShowFunctions.Synchronous.CoreManagement.Hashes
{
    ...
    {
        internal HashesF(ClassEngine engine) : base(engine)
        {
        }
        ...
        public void HSET(string key, string field, int value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, long value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, double value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, float value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, decimal value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, string value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, char value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, bool value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params int[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params long[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params double[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params float[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params decimal[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params string[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params char[] value) => Insert_HashesClass(key, field, value);
        ...
        /// </remarks>
        /// <returns>No return value.</returns>
        public void HSET(string key, string field, params bool[] value) => Insert_HashesClass(key, field, value);
        //==================================
        //==================================
        ...
        /// </returns>
        public bool DEL(string key) => Delete_HashesClass(key);
        ...
        /// </returns>
        public bool DEL(string key, string field) => Delete_Hashes_HashesClass(key, field);
        ...
        /// <b>true</b> if any field was deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool DEL(string key, params string[] field) => Delete_Hashes_HashesClass(key, field);
        ...
        /// </returns>
        public bool HDEL(string key, string field, int value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, long value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, double value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, float value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, decimal value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, string value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, char value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if the value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, bool value) => Delete_item_HashesClass(key, field, value);
        ...
        /// </returns>
        public bool HDEL(string key, string field, params int[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params long[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params double[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params float[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params decimal[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params string[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params char[] value) => Delete_item_HashesClass(key, field, value);
        ...
        /// <b>true</b> if any value was found and deleted; otherwise, <b>false</b>.
        /// </returns>
        public bool HDEL(string key, string field, params bool[] value) => Delete_item_HashesClass(key, field, value);
        //==================================
        //==================================
        ...
        public Dictionary<string, object> GET(string key) => ReadKey_HashesClass(key);
        ...
        public dynamic HGET(string key, string field) => ReadKeyField_HashesClass(key, field);
        ...
        /// </returns>
        public bool EXISTS(string key) => KeyExists_HashesClass(key);
        ...
        public List<string> KEYS() => Search_HashesClass().keys;
        ...
        public List<string> TOTAL_FIELDS() => Search_HashesClass().fields;
        ...
        public int COUNT_KEYS() => Search_HashesClass().countKeys;
        ...
        public int COUNT_TOTAL_FIELDS() => Search_HashesClass().countFields;
        ...
        public List<string> FIELDS(string key) => SearchField_HashesClass(key).field;
        ...
        public int COUNT_FIELDS(string key) => SearchField_HashesClass(key).count;
        ...
        /// </returns>
        public bool RENAME(string oldKey, string newKey) => Rename_HashesClass(oldKey, newKey);
        ...
        /// </returns>
        public bool HRENAME(string oldKey, string field, string newField) => RenameField_HashesClass(oldKey, field, newField);
    }
}
